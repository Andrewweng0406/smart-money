...
def test_is_market_trading_day_false_on_market_holiday():
    assert data_fetcher.is_market_trading_day(date(2026, 12, 25)) is False


def test_is_market_trading_day_true_on_early_close_session():
    assert data_fetcher.is_market_trading_day(date(2026, 11, 27)) is True
